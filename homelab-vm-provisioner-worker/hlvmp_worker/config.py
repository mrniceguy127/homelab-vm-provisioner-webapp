...
class WorkerConfig:
    ...
    def __init__(
        ...
        db_service_base_url: Optional[str] = None,
        ...
        Args:
            database_url: PostgreSQL connection URL (deprecated, use db_service_base_url)
            ...
            db_service_base_url: Database microservice base URL (built from host+port)
        ...
        self.db_service_base_url = db_service_base_url
    ...
    def from_env(cls) -> "WorkerConfig":
        ...
        db_service_base_url = f"http://{db_service_host}:{db_service_port}"
